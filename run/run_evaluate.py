...
def run_test(writer,epoch,model):
    """
    offline evaluation
    """
...
def run_test2(writer,epoch,model):
    """
    offline evaluation
    """
    ...
    # logger.info(f'CPA-constraint: {cpa_constraint}')
    # logger.info(f'Score: {score}')
    writer.add_scalar("Test/Total Reward",all_reward,epoch)
    writer.add_scalar("Test/Total Cost",all_cost,epoch)
    writer.add_scalar("Test/CPA-real",cpa_real,epoch)
    writer.add_scalar("Test/CPA-constraint",cpa_constraint,epoch)
